                ...
                <form onSubmit={handleSubmit}>
                  <div className='form-control mb-4 flex flex-col'>
                      <label className='label'>
                        <span className='label-text text-lg mb-2'>Title</span>
                      </label>
                  ...
                  <div className='form-control mb-4 flex flex-col'>
                      ...
                      <textarea placeholder='Write your note here...' value={content} onChange={(e)=> setContent(e.target.value)} className='textarea textarea-bordered h-32 w-full'></textarea>
                  </div>
